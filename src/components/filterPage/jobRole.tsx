...
const JobRoleFilter: FunctionComponent = () => {
        ...
        <ThemeProvider theme={theme}>
            <>
                <TextField
                    ...
                    InputProps={{
                        startAdornment: <Image src='/job.svg' alt='industries' height={20} width={20} style={{ marginRight: '10px' }} />,
                ...
                >
                    ...
                    >
                        {industries.map((industries, index) => (
                            <ListItemButton
                                key={industries}
                                onClick={() => handleIndustriesSelect(industries)}
                                sx={{
