    ...
    : [
        {
          ...
          description:
            "Lead digital marketing strategies for a growing e-commerce platform. Develop and execute campaigns to enhance brand visibility, collaborate with Key Opinion Leaders (KOLs) to boost engagement, and optimize content for multiple social media channels.",
        ...
        },
        {
          ...
          description:
            "Join GreenWave Tech to design intuitive and visually appealing interfaces for our sustainability-focused mobile app. Collaborate with product managers and developers to create user-centered designs and iterate on prototypes.",
        ...
        },
        {
          ...
          description:
            "Build and maintain responsive web applications for NovaTech's AI-driven platform. Work closely with the design team to implement modern ui components and ensure seamless user experiences.",
          ...
          (_, rowIndex) => (
            ...
            >
              {jobData
                ...
                .map((job, index: React.Key | null | undefined) => (
                  <JobCard
                    key={index}
                    width={{ xs: "100%", sm: "32%" }}
                    job={job}
