        ...
        <Box sx={{width: "100%"}}>
            ...
            >
                <Container maxWidth="md">
                    ...
                    >
                        Let&#39;s face it - all recruitment agencies are looking at the same
                        candidates. It&#39;s our service that separates us from the rest of
                        the crowd.
                    </Typography>
                </Container>
            </Box>
            ...
            <Container maxWidth="lg" sx={{textAlign: "center", mt: -4}}>
                ...
                >
                    <Box
                        component="img"
                        src="landing_page_guy_2.png"
                        alt="Landing page guy"
                        sx={{
                            width: {xs: "100%", md: "75%"},
                            height: {xs: "100%", md: "75%"},
                        }}
