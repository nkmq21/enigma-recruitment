// src/components/sections/cvs/builder/Experience.tsx
                    ...
                    <Box key={idx} sx={{p: 2, borderRadius: 2, border: "1px solid #EDF2F7"}}>
                        <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{mb: 1}}>
                            ...
                            <Tooltip title="Remove job">
                                <IconButton onClick={() => onRemove(idx)} size="small"><Delete
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid size={{xs: 6, mdx: 3}}>
                                <TextField label="End" fullWidth value={job.end}
                        ...
                        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{mb: 1}}>
                            ...
                            <Tooltip title="Add bullet">
                                <IconButton onClick={() => onAddBullet(idx)} size="small"><Add
                                    fontSize="small"/></IconButton>
                            </Tooltip>
                        </Stack>
